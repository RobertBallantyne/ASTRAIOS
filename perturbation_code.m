...
am = 1000 * mu_M*[((RM_sat(1)/rM_sat^3) - (RM(1)/rM^3)) ; ...
...
as = 1000 * mu_S*[((RS_sat(1)/rS_sat^3) - (RS(1)/rS^3)) ; ...
...
aSRP = -PSR * [uS_sat(1) ; uS_sat(2) ; uS_sat(3)];
%% Atmospheric Drag
ad = atmos_drag(x , y , z , u , v , w);
%% TOTAL
